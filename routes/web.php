...
Route::prefix('mock')->group(function () {
    ...
    // 1. Provider A Mock Endpoint
    Route::get('/provider-a', function () {
    ...
    // 2. Provider B Mock Endpoint
    Route::get('/provider-b', function () {
        return response()->json([
            "data" => [
    ...
    // 3. Provider C Mock Endpoint
    Route::get('/provider-c', function () {
        return response()->json([
            "results" => [
